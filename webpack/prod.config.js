...
var webpackIsomorphicToolsPlugin = new IsomorphicPlugin(
  require('./isomorphic-tools-configuration')
);
...
module.exports = {
  ...
  target: 'web',
  cache: false,
  entry: ['bootstrap-sass!./bootstrap.config.prod.js', './src/client.js'],
  stats: {
    colors: true,
    reasons: false
  },
  ...
  module: {
    loaders: [
      ...
      },
      {
        test: /\.svg(\?v=\d+\.\d+\.\d+)?$/,
        loader:
          'url?name=images/[name].[ext]&limit=10000&mimetype=image/svg+xml'
      },
      {
