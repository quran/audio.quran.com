...
module.exports = Object.assign({
  ...
  app: {
    ...
    head: {
      ...
      meta: [
        {name: 'description', content: 'QuranicAudio is your source for high quality recitations of the Quran. Stream or download all the Quran recitations'},
        {name: 'keyword', content: 'quran, quran mp3, quran audio, quranic audio, islam audio, quran play, quran recritation, islam'},
        {charset: 'utf-8'},
        ...
        {property: 'og:description', content: 'QuranicAudio is your source for high quality recitations of the Quran. Stream or download all the Quran recitations'},
