...
>
	<h1
		class="mt-[20px] mb-[10px] inline-block font-['Montserrat-Bold'] text-[40px] leading-[1.1] font-medium md:text-[48px]"
	>
		QuranicAudio
	</h1>
</header>
...
<div class="relative bg-white top-[10px] mx-[5%] md:top-0 md:mx-[20%]">
	<h1 class="mt-[20px] mb-[10px] text-[36px] font-medium text-[#444]">About</h1>
	<p class="m-0 mb-[10px] text-[#444] text-[14px] leading-[20px]">
		...
		not use these files for commercial purposes as many of these files have rules and regulations
		that prevent their sale except by the publishing companies.
	</p>
	<p class="m-0 mb-[10px] text-[#444] text-[14px] leading-[20px]">
		...
		<a class="text-[#2ca4ab]" href="http://dhikrullah.com/">dhikrullah.com</a>, and others. Many
		of the files have also been sent to us by some of our users, may Allah reward them greatly.
	</p>
</div>
